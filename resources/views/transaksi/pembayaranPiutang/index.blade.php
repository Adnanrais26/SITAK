...
<div class="content">
    ...
    <div class="page-header">
        <h1 class="title">Laporan Pembayaran Piutang</h1>
        <ol class="breadcrumb">
    ...
    <div class="container-padding">
        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table id="datajenis" class="table display">
                            ...
                            <tbody>
                                @foreach ($pengeluaranPiutangs as $pengeluaran)
                                ...
                                <tr>
                                    ...
                                    {{-- <td> --}}
                                        ...
                                        <!-- Modal edit akun-->
                                        {{-- <form action="{{ route('pembayaranPiutang.update', $pengeluaran->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Edit pembayaranPiutang</h4>
                                                        </div>
                                        ...
                                        <!-- Modal hapus akun-->
                                        {{-- <form action="/pembayaranPiutang/{{ $pengeluaran->id }}" method="POST"
                                            class="d-inline">
                                            @method('delete')
                                            @csrf
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close"><span
                                                                    aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title">Hapus pembayaranPiutang Permanen?</h4>
                                                        </div>
            ...
            <!-- Modal tambah akun-->
            <form action="{{ route('pembayaranPiutang.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                        aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Tambah pembayaranPiutang</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
