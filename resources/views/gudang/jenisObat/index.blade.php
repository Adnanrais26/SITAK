                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal Aktif akun-->
                                        <form action="{{ route('jenisObat.aktif', $jenis->id) }}" method="POST"
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal edit akun-->
                                        <form action="{{ route('jenisObat.update', $jenis->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="input1"
                                                                    name="jenisObat" value="{{ $jenis->jenisObat }}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="input2"
                                        ...
                                        <!-- Modal hapus akun-->
                                        <form action="/jenisObat/{{ $jenis->id }}" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <button type="button" class="btn btn-flat btn-primary"
                                                                data-dismiss="modal">No</button>
                                                            {{-- <a href="{{ route('jenisObat.destroy', $user->id) }}"
                ...
                <div class="modal fade" id="myModalTambah" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="input1" class="form-label">jenis Obat</label>
                                    <input type="text" class="form-control" id="input1" name="jenisObat">
                                </div>
                                <div class="form-group">
